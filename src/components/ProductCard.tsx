...
const ProductCard = ({ product }: ProductCardProps ) => {
    ...
    return ( 
        <div className="grid grid-cols-5 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <h3>{product.name}</h3>
            <p className="text-lg text-gray-300">{product.price.toLocaleString()}원</p>
            <p className="text-lg text-red-500">{product.percent}%</p>
            <p className="text-lg text-neutral-950">{product.discount.toLocaleString()}원</p>
            <button 
